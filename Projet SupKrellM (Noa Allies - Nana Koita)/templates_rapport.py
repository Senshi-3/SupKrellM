...
#Template 1 qui est l'interface du site (la page qui ne se réinitialise pas toutes les 2sec)
PAGE_MODELE = r"""
<!DOCTYPE html>
<html lang="fr">
<head>
...
#Template 2 qui est la page avec les données du système Linux (la page qui réinitialise toutes les 2sec)
PAGE_DONNEES = r"""
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body>
    <main>
        ...
        <section id="erreurs" class="section">
            <h2 id="texte-erreurs" style="color:#d64545">Erreurs</h2>
...
#Liste des jetons qui sont insérés tel quel
JETONS_BRUTS = {
    "LIGNES_TEMPERATURES",
    "ELEMENTS_ALIM",
    "LIGNES_DISQUES",
...
#Remplace les jetons dans "PAGE_DONNEES" avec les bonnes valeurs
